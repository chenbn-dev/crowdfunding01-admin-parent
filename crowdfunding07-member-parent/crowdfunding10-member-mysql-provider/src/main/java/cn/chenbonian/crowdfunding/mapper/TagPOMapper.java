...
import cn.chenbonian.crowdfunding.entity.po.TagPO;
import cn.chenbonian.crowdfunding.entity.po.TagPOExample;
...
public interface TagPOMapper {
  ...
  int updateByExampleSelective(
      @Param("record") TagPO record, @Param("example") TagPOExample example);
